...
;Timer.c,25 :: 		void interrupt()
;Timer.c,27 :: 		uiContTmp++;
...
;Timer.c,29 :: 		INTCON = 0x20;       // Set T0IE, clear T0IF
$0012	$3020			MOVLW	32
...
$0044	$0008			RETURN
$0045	$	_DisplayNum:
;Timer.c,33 :: 		void DisplayNum (void)
;Timer.c,41 :: 		if (uiSecondi_Attuale > 0)
$0045	$3080			MOVLW	128
...
;Timer.c,45 :: 		ucSecondi_Minuti = uiSecondi / 60;
$0052	$303C			MOVLW	60
...
;Timer.c,46 :: 		uiSecondi =  uiSecondi % 60;
$005D	$303C			MOVLW	60
...
;Timer.c,47 :: 		ucSecondi_Decine = uiSecondi / 10;
$006E	$300A			MOVLW	10
...
;Timer.c,48 :: 		ucSecondi_Unita = uiSecondi % 10;
$0079	$300A			MOVLW	10
...
$0089	$	L_DisplayNum_0:
;Timer.c,52 :: 		ucSecondi_Minuti = 0;
$0089	$01A0			CLRF	DisplayNum_ucSecondi_Minuti_L0, 1
;Timer.c,53 :: 		ucSecondi_Decine = 0;
$008A	$019F			CLRF	DisplayNum_ucSecondi_Decine_L0, 1
;Timer.c,54 :: 		ucSecondi_Unita = 0;
$008B	$019E			CLRF	DisplayNum_ucSecondi_Unita_L0, 1
;Timer.c,55 :: 		}
$008C	$	L_DisplayNum_1:
;Timer.c,57 :: 		switch(ucNumDisplay)
$008C	$28A8			GOTO	L_DisplayNum_2
;Timer.c,59 :: 		case 0: // Display delle unità di secondi
$008D	$	L_DisplayNum_4:
;Timer.c,60 :: 		DISPLAY_VALUE = ucSecondi_Unita;
$008D	$081E			MOVF	DisplayNum_ucSecondi_Unita_L0, 0
$008E	$0086			MOVWF	PORTB
;Timer.c,61 :: 		DISPLAY_VALUE = DISPLAY_VALUE + 16 + ucOutEnabled;
$008F	$3010			MOVLW	16
...
;Timer.c,63 :: 		case 1: // Display delle decine di secondi
$0096	$	L_DisplayNum_5:
;Timer.c,64 :: 		DISPLAY_VALUE = ucSecondi_Decine;
$0096	$081F			MOVF	DisplayNum_ucSecondi_Decine_L0, 0
$0097	$0086			MOVWF	PORTB
;Timer.c,65 :: 		DISPLAY_VALUE = DISPLAY_VALUE + 32 + ucOutEnabled;
$0098	$3020			MOVLW	32
...
;Timer.c,67 :: 		case 2: // Display dei minuti
$009F	$	L_DisplayNum_6:
;Timer.c,68 :: 		DISPLAY_VALUE = ucSecondi_Minuti;
$009F	$0820			MOVF	DisplayNum_ucSecondi_Minuti_L0, 0
$00A0	$0086			MOVWF	PORTB
;Timer.c,69 :: 		DISPLAY_VALUE = DISPLAY_VALUE + 64 + ucOutEnabled;
$00A1	$3040			MOVLW	64
...
$00B4	$	L_DisplayNum_3:
;Timer.c,72 :: 		ucNumDisplay++;
$00B4	$0A90			INCF	_ucNumDisplay, 1
;Timer.c,73 :: 		if (ucNumDisplay >= 3) ucNumDisplay = 0;
$00B5	$3003			MOVLW	3
...
$00BA	$	L_DisplayNum_7:
;Timer.c,74 :: 		} // END void DisplayNum (void)
$00BA	$0008			RETURN
$00BB	$	_EEprom_write:
$00BB	$0000			NOP
...
;Timer.c,136 :: 		if (uiSecondi_Attuale < 120) uiMaxInterrupt = 180;
$0160	$3080			MOVLW	128
...
;Timer.c,189 :: 		DisplayNum();
$0213	$2045			CALL	_DisplayNum
;Timer.c,190 :: 		Delay_ms(1);
$0214	$3002			MOVLW	2
...
$0226	$	L_main_38:
;Timer.c,192 :: 		} // END while (PORTA.F2 == 0)
$0226	$29B3			GOTO	L_main_28
$0227	$	L_main_29:
;Timer.c,195 :: 		while (PORTA.F3 == 0)
$0227	$	L_main_40:
$0227	$3000			MOVLW	0
...
;Timer.c,203 :: 		DisplayNum();
$024A	$2045			CALL	_DisplayNum
;Timer.c,204 :: 		Delay_ms(1);
$024B	$3002			MOVLW	2
...
$025D	$	L_main_45:
;Timer.c,207 :: 		if (uiSecondi_Attuale > 1)
$025D	$3080			MOVLW	128
...
;Timer.c,208 :: 		uiSecondi_Attuale = uiSecondi_Attuale - k;
...
;Timer.c,213 :: 		DisplayNum();
$027B	$2045			CALL	_DisplayNum
;Timer.c,214 :: 		Delay_ms(1);
$027C	$3002			MOVLW	2
...
$028E	$	L_main_50:
;Timer.c,216 :: 		} // END while (PORTA.F3 == 0)
$028E	$2A27			GOTO	L_main_40
$028F	$	L_main_41:
;Timer.c,219 :: 		if (PORTA.F1 == 0)
$028F	$3000			MOVLW	0
...
;Timer.c,221 :: 		cEsciLoop = 1;
$0297	$3001			MOVLW	1
$0298	$0097			MOVWF	main_cEsciLoop_L0
;Timer.c,223 :: 		while (PORTA.F1 == 0) { }
$0299	$	L_main_53:
$0299	$3000			MOVLW	0
...
$02A1	$	L_main_54:
;Timer.c,225 :: 		uiSecondi_Fine = uiSecondi_Attuale;
...
;Timer.c,229 :: 		EEprom_Write(1, uiSecondi_Fine & 0b11111111);
$02A5	$3001			MOVLW	1
...
$02C8	$2AC7			GOTO	$-1
$02C9	$0000			NOP
;Timer.c,231 :: 		EEprom_Write(3, uiSecondi_Fine / 0b11111111);
$02CA	$3003			MOVLW	3
