...
$0047	$0099	MOVWF	SPBRG
$0048	$1118	BCF	TXSTA, BRGH
$0049	$2004	CALL	_Usart_Init
$004A	$	L_main_0:
$004A	$201A	CALL	_Usart_Data_Ready
$004B	$1303	BCF	STATUS,RP1
$004C	$1283	BCF	STATUS,RP0
$004D	$01F0	CLRF 	STACK_0
$004E	$0821	MOVF	_Usart_Data_Ready_local_result,W
$004F	$0270	SUBWF	STACK_0,W
$0050	$1903	BTFSC	STATUS,Z
$0051	$2858	GOTO 	L_main_2
$0052	$2022	CALL	_Usart_Read
$0053	$0821	MOVF 	_Usart_Read_local_result,W
$0054	$00A0	MOVWF 	_i
$0055	$0820	MOVF 	_i,W
$0056	$00A1	MOVWF 	Usart_Write_argh0
$0057	$2033	CALL	_Usart_Write
$0058	$	L_main_2:
$0058	$284A	GOTO 	L_main_0
$0059	$	L_main_1:
$0059	$2859	GOTO 	$
